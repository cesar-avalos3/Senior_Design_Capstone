...
HD_PWD='E:/TimmyCore/TimmyCore/TimmyCore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TIMMYCORE_V2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TIMMYCORE_V2.tcl
