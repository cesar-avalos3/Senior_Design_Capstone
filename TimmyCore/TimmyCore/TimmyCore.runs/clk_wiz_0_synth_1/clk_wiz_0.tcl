...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir E:/TimmyCore/TimmyCore/TimmyCore.runs/clk_wiz_0_synth_1 -new_name clk_wiz_0 -ip [get_ips clk_wiz_0]]
...
if { [catch {
  file copy -force E:/TimmyCore/TimmyCore/TimmyCore.runs/clk_wiz_0_synth_1/clk_wiz_0.dcp e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force E:/TimmyCore/TimmyCore/TimmyCore.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.v e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/TimmyCore/TimmyCore/TimmyCore.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.vhdl e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/TimmyCore/TimmyCore/TimmyCore.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.v e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/TimmyCore/TimmyCore/TimmyCore.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.vhdl e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir E:/TimmyCore/TimmyCore/TimmyCore.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v E:/TimmyCore/TimmyCore/TimmyCore.ip_user_files/ip/clk_wiz_0
  }
}

if {[file isdir E:/TimmyCore/TimmyCore/TimmyCore.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force e:/TimmyCore/TimmyCore/TimmyCore.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl E:/TimmyCore/TimmyCore/TimmyCore.ip_user_files/ip/clk_wiz_0
  }
}
