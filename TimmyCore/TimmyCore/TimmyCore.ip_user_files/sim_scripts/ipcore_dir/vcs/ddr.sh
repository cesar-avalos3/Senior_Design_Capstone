...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/C:/Users/Cesar/Documents/GitHub/Ram2Ddr_RefComp/Source/Ram2DdrXadc_RefComp/ipcore_dir/ddr_sim_netlist.vhdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ddr -o ddr_simv
}
